...
@Entity
public class SalaryStatusChangeArg extends OperateDataBase {
	...
	@Column
	private long payPrincipalship;
	
	@Column
	private long payPrincipalshipLevel;
	...
	public long getPayPrincipalship() {
		return payPrincipalship;
	}

	public void setPayPrincipalship(long payPrincipalship) {
		this.payPrincipalship = payPrincipalship;
	}

	public long getPayPrincipalshipLevel() {
		return payPrincipalshipLevel;
	}

	public void setPayPrincipalshipLevel(long payPrincipalshipLevel) {
		this.payPrincipalshipLevel = payPrincipalshipLevel;
	}
