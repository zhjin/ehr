...
@Entity
public class RoleDefine extends EntityHasIdBase {
	...
	public void remove() throws Exception {
		Utility.getDBUtility().executeUpdate("delete roleitemdefine where roleid = :roleId", new ArgMap().add("roleId", this.getId()));
		Utility.getDBUtility().executeUpdate("delete RoleItemObjectDefine where roleid = :roleId", new ArgMap().add("roleId", this.getId()));
	}
}
